...
export const TRANSLATIONS = {
  ...
  'field.previousNo': { en: 'Previous No.', ar: 'الرقم السابق' },
  'field.previousNos': { en: 'Previous Numbers', ar: 'الأرقام السابقة' },
  'field.previousNoValue': { en: 'Number', ar: 'الرقم' },
  'field.previousNoNote': { en: 'Source / note', ar: 'المصدر / ملاحظة' },
  'field.previousNoHint': {
    en: 'Numbers this record carried under earlier cataloguing systems. Add as many as apply.',
    ar: 'الأرقام التي حملها هذا السجل في أنظمة الفهرسة السابقة. أضف ما يلزم منها.',
  },
  'field.previousNoNone': { en: 'None recorded', ar: 'لا توجد أرقام سابقة' },
  'action.addPreviousNo': { en: 'Add a previous number', ar: 'إضافة رقم سابق' },
  'action.removeRow': { en: 'Remove', ar: 'حذف' },
